...
VALUES (
	'Alice BORT Smith','Alice Smith','','','','','Smith','0987654321','1234567890','(480) 555-1234','Yes','July 4, 1985','alice.smith@us.af.mil','Organization','American Citizen','Y','F','English','Smith S. Smithson (480) 555-1234','123 Taft St, Crystal City, VA 22201','Apartment 205');
...
INSERT INTO COURSELIST(
	    course_id,course_name                        ,provider_name,start_date  ,end_date    ,award_date  ,expiration_date,status)
VALUES ('ACQ','Acquisition Management','USAF','01/01/2021','03/31/2021','','','Enrolled');
INSERT INTO COURSELIST(
	    course_id,course_name                        ,provider_name,start_date  ,end_date    ,award_date  ,expiration_date,status)
VALUES ('CON 091','Contracting Fundamentals','DAU','09/01/2020','12/20/2020','12/20/2020','12/20/2022','Complete');
INSERT INTO COURSELIST(
	    course_id,course_name                        ,provider_name,start_date  ,end_date    ,award_date  ,expiration_date,status)
VALUES ('CON 100','Shaping Smart Business Arrangements', 'DAU','09/01/2020','12/20/2020','12/20/2020','12/20/2022','Complete');
INSERT INTO COURSELIST(
	    course_id,course_name,provider_name,start_date  ,end_date    ,award_date  ,expiration_date,status)
VALUES ('CTC 103','Cyber Awareness','USAF','01/01/2021','03/31/2021','','','Enrolled');
INSERT INTO COURSELIST(
	    course_id,course_name                        ,provider_name,start_date  ,end_date    ,award_date  ,expiration_date,status)
VALUES ('CTC 101','Protecting Sensitive Information','USAF'        ,'01/01/2020','01/07/2021','01/07/2020','01/07/2022'   ,'Complete');
INSERT INTO COURSELIST(
	    course_id,course_name                        ,provider_name,start_date  ,end_date    ,award_date  ,expiration_date,status)
VALUES ('CTC 101','Protecting Sensitive Information','USAF'        ,'01/01/2020','01/07/2021','01/07/2020','01/07/2022'   ,'Complete');
